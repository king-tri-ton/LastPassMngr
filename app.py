...
from crypto_manager import PasswordStorage
from save_dialog import SavePasswordDialog
...
class PasswordGeneratorApp:
    def __init__(self):
        ...
        # Инициализируем хранилище с мастер-паролем
        try:
        ...
        if os.path.exists(icon_path):
            ...
            self.icon = QIcon()  # Пустая иконка если файл не найден
    ...
    def create_menu(self):
        ...
        # Не используем setContextMenu — будем открывать меню вручную
        # self.tray.setContextMenu(self.menu)
        
        # Подключаем обработчик события активации
    ...
    def show_tray_menu(self, reason):
        if reason == QSystemTrayIcon.ActivationReason.Context:
            ...
            # Координата курсора, но немного выше панели задач
