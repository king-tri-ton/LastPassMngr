...
├── storage.py      # Работа с шифрованием и хранилищем
├── manager.py      # Главное окно менеджера паролей
├── unlock.py       # Окно ввода/создания мастер-пароля
├── generator.py    # Генератор паролей
├── saver.py        # Окно сохранения пароля
